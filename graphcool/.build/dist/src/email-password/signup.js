...
exports.default = (function (event) { return __awaiter(_this, void 0, void 0, function () {
    var graphcool, api, _a, name, email, password, userExists, salt, hash, userId, token, e_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                _a = event.data, name = _a.name, email = _a.email, password = _a.password;
            ...
            case 3:
                hash = _b.sent();
                return [4 /*yield*/, createGraphcoolUser(api, name, email, hash)];
            case 4:
                userId = _b.sent();
...
function createGraphcoolUser(api, name, email, password) {
    return __awaiter(this, void 0, void 0, function () {
